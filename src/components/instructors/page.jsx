...
const Instructo = () => {
  ...
  return (
    <div >
      <div className="container  w-full sm:w-full m-auto mt-[30px]">
        <h1 className="text-[30px] text-center font-medium pb-[30px]">
          Our instructors
        </h1>

        <p className="text-center text-slate-400 pb-[50px]">
